...
// Runtime bytecode compiled from tests/fixtures/contracts/TestOnlyOwnedTarget.sol.
// We check it in here so the test-only sim harness can seed code into Tenderly
// without requiring a compile step during normal simulation runs.
