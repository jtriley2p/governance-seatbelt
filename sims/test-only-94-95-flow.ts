...
export const TEST_ONLY_CELO_PRE_94_OWNER = getAddress(
  '0x0Eb863541278308c3A64F8E908BC646e27BFD071',
);
...
export function build94To95TestOnlyCeloState(
  targets: readonly Address[],
): SeededStateObjects {
  return {
    42220: Object.fromEntries(
      targets.map((target) => [getAddress(target), buildTestOnlyOwnedTargetState(TEST_ONLY_CELO_PRE_94_OWNER)]),
    ),
  };
}
